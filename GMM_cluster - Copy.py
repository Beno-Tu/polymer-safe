...
def main():
    ...
    train=np.column_stack((preprocess_data1['Norm_Rtop'], preprocess_data1['Norm_Top'], preprocess_data1['Norm_Close']))
    t1=np.column_stack((preprocess_data2['Norm_Rtop'], preprocess_data2['Norm_Top'], preprocess_data2['Norm_Close']))
    t2=np.column_stack((preprocess_data3['Norm_Rtop'], preprocess_data3['Norm_Top'], preprocess_data3['Norm_Close']))
